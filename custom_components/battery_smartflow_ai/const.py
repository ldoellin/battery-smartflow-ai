...
INTEGRATION_VERSION = "4.4.0-custom"
...
CONF_PV_DAILY_YIELD_ENTITY           = "pv_daily_yield_entity"  # PV Tagesertrag (kWh) für Fallback
...
CONF_ADDITIONAL_BATTERY_CHARGE_MODE  = "additional_battery_charge_mode"    # z.B. "Laden"
CONF_ADDITIONAL_BATTERY_STOP_MODE    = "additional_battery_stop_mode"      # z.B. "Automatik"
CONF_ADDITIONAL_BATTERY_PAUSE_MODE   = "additional_battery_pause_mode"     # z.B. "Pause" (kein Laden, kein Entladen)
